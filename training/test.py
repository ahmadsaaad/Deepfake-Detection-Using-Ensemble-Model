...
parser.add_argument('--detector_path', type=str, 
                    default='/Users/ahmedabdelaziz/Masters/Models/DeepfakeBench-main/training/config/detector/ffd.yaml',
                    help='path to detector YAML file')
parser.add_argument("--test_dataset", nargs="+", default=['FF-DF'])
parser.add_argument('--weights_path', type=str, 
                    default='/Users/ahmedabdelaziz/Masters/Models/DeepfakeBench-main/training-results/ucf_resnet/ucf_2023-08-25-01-39-18/test/FF-DF/ckpt_best.pth')
...
def main():
    ...
    # save tsne
    with open(os.path.join('/Users/ahmedabdelaziz/Masters/Models/DeepfakeBench-main/test_results//tsne', f"tsne_dict_{config['model_name']}_{epoch}.pkl"), 'wb') as f:
